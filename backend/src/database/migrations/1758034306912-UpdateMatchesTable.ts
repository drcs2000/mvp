...
export class UpdateMatchesTable1758034306912 implements MigrationInterface {
    name = 'UpdateMatchesTable1758034306912'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."matches_status_enum" RENAME TO "matches_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."matches_status_enum" AS ENUM('TBD', 'NS', '1H', '2H', 'HT', 'FT', 'PST', 'CANC', 'ABD')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."matches_status_enum_old" AS ENUM('TBD', 'NS', '1H', '2H', 'HT', 'FT', 'PST', 'CANC')`);
        await queryRunner.query(`ALTER TABLE "matches" ALTER COLUMN "status" DROP DEFAULT`);
