...
export class UpdateMatchesTable21758034397418 implements MigrationInterface {
    name = 'UpdateMatchesTable21758034397418'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."matches_status_enum" RENAME TO "matches_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."matches_status_enum" AS ENUM('TBD', 'NS', '1H', '2H', 'HT', 'FT', 'PST', 'CANC', 'ABD', 'PEN')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."matches_status_enum_old" AS ENUM('TBD', 'NS', '1H', '2H', 'HT', 'FT', 'PST', 'CANC', 'ABD')`);
        await queryRunner.query(`ALTER TABLE "matches" ALTER COLUMN "status" DROP DEFAULT`);
